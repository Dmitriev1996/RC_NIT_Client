...
public class CourceDAO {
	...
	private String URL="http://localhost:8080/WebJsp/webresources/Cource/";
	...
	public ArrayList<Cource> getCourceList() throws ClientProtocolException, IOException{
		String json="";
		String str="";
		...
		gson=builder.create();
		Type type=new TypeToken<ArrayList<Cource>>() {}.getType();
	    ArrayList<Cource> courcelist=gson.fromJson(json, type);
	    return courcelist;
