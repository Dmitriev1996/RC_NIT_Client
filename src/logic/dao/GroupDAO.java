...
public class GroupDAO {
	...
	private String URL="http://localhost:8080/WebJsp/webresources/Group/";
	...
	public ArrayList<Group> getGroupList() throws ClientProtocolException, IOException{
		String json="";
		String str="";
		...
		ArrayList<Group> grouplist=gson.fromJson(json, type);
		return grouplist;
	}
	
	public Group getGroupById(int id) throws ClientProtocolException, IOException {
		   String json="";
		   String str="";
		   builder=new GsonBuilder();
		   gson=builder.setPrettyPrinting().create();
	       ...
	       return gson.fromJson(obj, Group.class);
	}
	
	public ArrayList<Group> getGroupListAtParams(String params) throws ClientProtocolException, IOException{
		String json="";
		String str="";
		builder=new GsonBuilder();
		gson=builder.setPrettyPrinting().create();
	...
	public String insertGroup(Group group) throws ClientProtocolException, IOException {
		   String json="";
		   String str="";
		   builder=new GsonBuilder();
		   gson=builder.setPrettyPrinting().create();
	...
	public String updateGroup(Group group) throws ClientProtocolException, IOException {
		String json="";
		String str="";
		builder=new GsonBuilder();
		gson=builder.setPrettyPrinting().create();
