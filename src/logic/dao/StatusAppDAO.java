...
public class StatusAppDAO {
	...
	private String URL="http://localhost:8080/WebJsp/webresources/StatusApp/";
	...
	public ArrayList<StatusApp> getStatusAppList() throws ClientProtocolException, IOException {
		String json="";
		String str="";
		...
		gson=builder.create();
		Type type=new TypeToken<ArrayList<StatusApp>>() {}.getType();
	    ArrayList<StatusApp> statusapplist=gson.fromJson(json, type);
