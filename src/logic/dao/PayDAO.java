...
public class PayDAO {
	...
	private String URL="http://localhost:8080/WebJsp/webresources/Pay/";
	...
	public ArrayList<Pay> getPayList() throws ClientProtocolException, IOException{
		String json="";
		String str="";
		...
		gson=builder.create();
		Type type=new TypeToken<ArrayList<Pay>>() {}.getType();
	    ArrayList<Pay> paylist=gson.fromJson(json, type);
	    return paylist;
	}
