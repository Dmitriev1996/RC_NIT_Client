...
public class NewPhysfaceInGroup extends JFrame {
	...
	public NewPhysfaceInGroup() {
		...
		ok.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
			    ...
			    list.put(null, physface);
			    PhysfaceRow physfacerow=new PhysfaceRow();
			    physfacerow.setStatus("insert");
			    physfacerow.setPhysface(physface);
			    UpdateYurfaceApp.physfacelist.add(physface);
			    int row=UpdateYurfaceApp.physfacelist.size()-1;
			    physfacerow.setNumRow(row);
