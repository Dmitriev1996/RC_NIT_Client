...
public class OrderAdmissionPhysfaceTableModel implements TableModel {
	private Set<TableModelListener> listeners=new HashSet<TableModelListener>();
	private ArrayList<OrderAdmission> orderlist;
	
	public OrderAdmissionPhysfaceTableModel(ArrayList<OrderAdmission> orderlist) {
	...
	public Object getValueAt(int rowIndex, int columnIndex) {
		...
		case 1:
			return order.getContractsOrdersPhysfaces_ID();
		case 2:
