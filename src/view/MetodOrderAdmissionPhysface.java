...
public class MetodOrderAdmissionPhysface extends JPanel {
	...
	private ContractOrderPhysfaceDAO contractdao=new ContractOrderPhysfaceDAO();
	...
	public MetodOrderAdmissionPhysface() throws ClientProtocolException, IOException {
		setSize(300, 300);
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(ContractCheck.isSelected()) {
					if(parameters.isEmpty()) {
						str="ContractsOrdersPhysfaces_ID="+Contract.getSelectedItem();
					} else {
						str=" AND ContractsOrdersPhysfaces_ID="+Contract.getSelectedItem();
					}
					parameters.put("ContractPhysface", str);
				}
	...
	private void createSamples() throws ClientProtocolException, IOException {
		for(ContractOrderPhysface contract : contractdao.getContractPhysfaceList()) {
			Contract.addItem(contract.getContractsOrdersPhysfaces_ID());
		}
